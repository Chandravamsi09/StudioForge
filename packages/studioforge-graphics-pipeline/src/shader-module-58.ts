/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_58
...
export interface GraphicsShaderModule_58Uniforms {
...
export class GraphicsShaderModule_58Pipeline {
  private uniforms: GraphicsShaderModule_58Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_58Uniforms>) {
    this.uniforms = {
