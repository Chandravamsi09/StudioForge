/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_24
...
export interface GraphicsShaderModule_24Uniforms {
...
export class GraphicsShaderModule_24Pipeline {
  private uniforms: GraphicsShaderModule_24Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_24Uniforms>) {
    this.uniforms = {
