/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_37
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_37DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_37Executor {
  private descriptor: ComputeShaderPipeline_37DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_37DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_37_MainKernel',
