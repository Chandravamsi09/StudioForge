/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_32
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_32DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_32Executor {
  private descriptor: ComputeShaderPipeline_32DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_32DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_32_MainKernel',
