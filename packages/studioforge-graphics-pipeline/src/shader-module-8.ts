/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_8
...
export interface GraphicsShaderModule_8Uniforms {
...
export class GraphicsShaderModule_8Pipeline {
  private uniforms: GraphicsShaderModule_8Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_8Uniforms>) {
    this.uniforms = {
