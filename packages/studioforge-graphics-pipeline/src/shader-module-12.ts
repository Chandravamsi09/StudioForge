/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_12
...
export interface GraphicsShaderModule_12Uniforms {
...
export class GraphicsShaderModule_12Pipeline {
  private uniforms: GraphicsShaderModule_12Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_12Uniforms>) {
    this.uniforms = {
