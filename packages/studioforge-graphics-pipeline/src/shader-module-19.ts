/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_19
...
export interface GraphicsShaderModule_19Uniforms {
...
export class GraphicsShaderModule_19Pipeline {
  private uniforms: GraphicsShaderModule_19Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_19Uniforms>) {
    this.uniforms = {
