/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_15
...
export interface GraphicsShaderModule_15Uniforms {
...
export class GraphicsShaderModule_15Pipeline {
  private uniforms: GraphicsShaderModule_15Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_15Uniforms>) {
    this.uniforms = {
