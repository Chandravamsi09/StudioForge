/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_36
...
export interface GraphicsShaderModule_36Uniforms {
...
export class GraphicsShaderModule_36Pipeline {
  private uniforms: GraphicsShaderModule_36Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_36Uniforms>) {
    this.uniforms = {
