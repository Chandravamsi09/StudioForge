/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_32
...
export interface GraphicsShaderModule_32Uniforms {
...
export class GraphicsShaderModule_32Pipeline {
  private uniforms: GraphicsShaderModule_32Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_32Uniforms>) {
    this.uniforms = {
