/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_20
...
export interface GraphicsShaderModule_20Uniforms {
...
export class GraphicsShaderModule_20Pipeline {
  private uniforms: GraphicsShaderModule_20Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_20Uniforms>) {
    this.uniforms = {
