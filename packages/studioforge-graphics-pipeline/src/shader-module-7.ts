/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_7
...
export interface GraphicsShaderModule_7Uniforms {
...
export class GraphicsShaderModule_7Pipeline {
  private uniforms: GraphicsShaderModule_7Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_7Uniforms>) {
    this.uniforms = {
