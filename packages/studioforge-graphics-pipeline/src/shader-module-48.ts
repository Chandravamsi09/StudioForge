/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_48
...
export interface GraphicsShaderModule_48Uniforms {
...
export class GraphicsShaderModule_48Pipeline {
  private uniforms: GraphicsShaderModule_48Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_48Uniforms>) {
    this.uniforms = {
