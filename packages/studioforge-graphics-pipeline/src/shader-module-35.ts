/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_35
...
export interface GraphicsShaderModule_35Uniforms {
...
export class GraphicsShaderModule_35Pipeline {
  private uniforms: GraphicsShaderModule_35Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_35Uniforms>) {
    this.uniforms = {
