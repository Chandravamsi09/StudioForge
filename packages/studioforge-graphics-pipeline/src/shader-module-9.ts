/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_9
...
export interface GraphicsShaderModule_9Uniforms {
...
export class GraphicsShaderModule_9Pipeline {
  private uniforms: GraphicsShaderModule_9Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_9Uniforms>) {
    this.uniforms = {
