/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_21
...
export interface GraphicsShaderModule_21Uniforms {
...
export class GraphicsShaderModule_21Pipeline {
  private uniforms: GraphicsShaderModule_21Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_21Uniforms>) {
    this.uniforms = {
