/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_16
...
export interface GraphicsShaderModule_16Uniforms {
...
export class GraphicsShaderModule_16Pipeline {
  private uniforms: GraphicsShaderModule_16Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_16Uniforms>) {
    this.uniforms = {
