/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_28
...
export interface GraphicsShaderModule_28Uniforms {
...
export class GraphicsShaderModule_28Pipeline {
  private uniforms: GraphicsShaderModule_28Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_28Uniforms>) {
    this.uniforms = {
