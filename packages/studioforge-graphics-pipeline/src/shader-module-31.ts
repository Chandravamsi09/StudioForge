/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_31
...
export interface GraphicsShaderModule_31Uniforms {
...
export class GraphicsShaderModule_31Pipeline {
  private uniforms: GraphicsShaderModule_31Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_31Uniforms>) {
    this.uniforms = {
