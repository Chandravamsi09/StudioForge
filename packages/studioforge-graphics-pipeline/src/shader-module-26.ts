/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_26
...
export interface GraphicsShaderModule_26Uniforms {
...
export class GraphicsShaderModule_26Pipeline {
  private uniforms: GraphicsShaderModule_26Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_26Uniforms>) {
    this.uniforms = {
