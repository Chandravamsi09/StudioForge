/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_51
...
export interface GraphicsShaderModule_51Uniforms {
...
export class GraphicsShaderModule_51Pipeline {
  private uniforms: GraphicsShaderModule_51Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_51Uniforms>) {
    this.uniforms = {
