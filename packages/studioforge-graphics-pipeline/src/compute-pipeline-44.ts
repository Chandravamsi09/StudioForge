/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_44
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_44DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_44Executor {
  private descriptor: ComputeShaderPipeline_44DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_44DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_44_MainKernel',
