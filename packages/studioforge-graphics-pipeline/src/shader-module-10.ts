/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_10
...
export interface GraphicsShaderModule_10Uniforms {
...
export class GraphicsShaderModule_10Pipeline {
  private uniforms: GraphicsShaderModule_10Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_10Uniforms>) {
    this.uniforms = {
