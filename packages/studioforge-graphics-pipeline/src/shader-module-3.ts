/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_3
...
export interface GraphicsShaderModule_3Uniforms {
...
export class GraphicsShaderModule_3Pipeline {
  private uniforms: GraphicsShaderModule_3Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_3Uniforms>) {
    this.uniforms = {
