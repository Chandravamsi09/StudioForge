/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_60
...
export interface GraphicsShaderModule_60Uniforms {
...
export class GraphicsShaderModule_60Pipeline {
  private uniforms: GraphicsShaderModule_60Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_60Uniforms>) {
    this.uniforms = {
