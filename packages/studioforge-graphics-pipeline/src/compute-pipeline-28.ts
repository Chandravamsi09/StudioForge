/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_28
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_28DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_28Executor {
  private descriptor: ComputeShaderPipeline_28DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_28DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_28_MainKernel',
