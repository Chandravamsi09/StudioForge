/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_49
...
export interface GraphicsShaderModule_49Uniforms {
...
export class GraphicsShaderModule_49Pipeline {
  private uniforms: GraphicsShaderModule_49Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_49Uniforms>) {
    this.uniforms = {
