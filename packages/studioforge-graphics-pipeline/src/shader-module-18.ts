/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_18
...
export interface GraphicsShaderModule_18Uniforms {
...
export class GraphicsShaderModule_18Pipeline {
  private uniforms: GraphicsShaderModule_18Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_18Uniforms>) {
    this.uniforms = {
