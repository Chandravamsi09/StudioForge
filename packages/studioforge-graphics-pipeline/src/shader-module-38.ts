/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_38
...
export interface GraphicsShaderModule_38Uniforms {
...
export class GraphicsShaderModule_38Pipeline {
  private uniforms: GraphicsShaderModule_38Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_38Uniforms>) {
    this.uniforms = {
