/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_14
...
export interface GraphicsShaderModule_14Uniforms {
...
export class GraphicsShaderModule_14Pipeline {
  private uniforms: GraphicsShaderModule_14Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_14Uniforms>) {
    this.uniforms = {
