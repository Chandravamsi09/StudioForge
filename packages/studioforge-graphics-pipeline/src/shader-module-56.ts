/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_56
...
export interface GraphicsShaderModule_56Uniforms {
...
export class GraphicsShaderModule_56Pipeline {
  private uniforms: GraphicsShaderModule_56Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_56Uniforms>) {
    this.uniforms = {
