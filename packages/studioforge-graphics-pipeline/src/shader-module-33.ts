/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_33
...
export interface GraphicsShaderModule_33Uniforms {
...
export class GraphicsShaderModule_33Pipeline {
  private uniforms: GraphicsShaderModule_33Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_33Uniforms>) {
    this.uniforms = {
