/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_2
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_2DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_2Executor {
  private descriptor: ComputeShaderPipeline_2DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_2DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_2_MainKernel',
