/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_11
...
export interface GraphicsShaderModule_11Uniforms {
...
export class GraphicsShaderModule_11Pipeline {
  private uniforms: GraphicsShaderModule_11Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_11Uniforms>) {
    this.uniforms = {
