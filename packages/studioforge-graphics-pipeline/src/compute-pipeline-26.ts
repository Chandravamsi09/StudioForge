/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_26
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_26DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_26Executor {
  private descriptor: ComputeShaderPipeline_26DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_26DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_26_MainKernel',
