/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_1
...
export interface GraphicsShaderModule_1Uniforms {
...
export class GraphicsShaderModule_1Pipeline {
  private uniforms: GraphicsShaderModule_1Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_1Uniforms>) {
    this.uniforms = {
