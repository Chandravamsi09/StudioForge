/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_40
...
export interface GraphicsShaderModule_40Uniforms {
...
export class GraphicsShaderModule_40Pipeline {
  private uniforms: GraphicsShaderModule_40Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_40Uniforms>) {
    this.uniforms = {
