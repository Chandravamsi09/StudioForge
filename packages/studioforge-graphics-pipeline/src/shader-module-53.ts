/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_53
...
export interface GraphicsShaderModule_53Uniforms {
...
export class GraphicsShaderModule_53Pipeline {
  private uniforms: GraphicsShaderModule_53Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_53Uniforms>) {
    this.uniforms = {
