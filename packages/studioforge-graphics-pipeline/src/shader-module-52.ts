/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_52
...
export interface GraphicsShaderModule_52Uniforms {
...
export class GraphicsShaderModule_52Pipeline {
  private uniforms: GraphicsShaderModule_52Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_52Uniforms>) {
    this.uniforms = {
