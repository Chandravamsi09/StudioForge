/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_30
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_30DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_30Executor {
  private descriptor: ComputeShaderPipeline_30DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_30DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_30_MainKernel',
