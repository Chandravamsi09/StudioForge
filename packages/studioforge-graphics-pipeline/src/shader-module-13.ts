/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_13
...
export interface GraphicsShaderModule_13Uniforms {
...
export class GraphicsShaderModule_13Pipeline {
  private uniforms: GraphicsShaderModule_13Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_13Uniforms>) {
    this.uniforms = {
