/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_34
...
export interface GraphicsShaderModule_34Uniforms {
...
export class GraphicsShaderModule_34Pipeline {
  private uniforms: GraphicsShaderModule_34Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_34Uniforms>) {
    this.uniforms = {
