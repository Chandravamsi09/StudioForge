/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_22
...
export interface GraphicsShaderModule_22Uniforms {
...
export class GraphicsShaderModule_22Pipeline {
  private uniforms: GraphicsShaderModule_22Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_22Uniforms>) {
    this.uniforms = {
