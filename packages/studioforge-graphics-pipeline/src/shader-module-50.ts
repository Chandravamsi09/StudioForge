/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_50
...
export interface GraphicsShaderModule_50Uniforms {
...
export class GraphicsShaderModule_50Pipeline {
  private uniforms: GraphicsShaderModule_50Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_50Uniforms>) {
    this.uniforms = {
