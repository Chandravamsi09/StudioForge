/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_27
...
export interface GraphicsShaderModule_27Uniforms {
...
export class GraphicsShaderModule_27Pipeline {
  private uniforms: GraphicsShaderModule_27Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_27Uniforms>) {
    this.uniforms = {
