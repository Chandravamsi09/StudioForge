/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_6
...
export interface GraphicsShaderModule_6Uniforms {
...
export class GraphicsShaderModule_6Pipeline {
  private uniforms: GraphicsShaderModule_6Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_6Uniforms>) {
    this.uniforms = {
