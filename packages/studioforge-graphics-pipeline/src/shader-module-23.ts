/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_23
...
export interface GraphicsShaderModule_23Uniforms {
...
export class GraphicsShaderModule_23Pipeline {
  private uniforms: GraphicsShaderModule_23Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_23Uniforms>) {
    this.uniforms = {
