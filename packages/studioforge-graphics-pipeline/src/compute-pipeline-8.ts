/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_8
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_8DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_8Executor {
  private descriptor: ComputeShaderPipeline_8DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_8DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_8_MainKernel',
