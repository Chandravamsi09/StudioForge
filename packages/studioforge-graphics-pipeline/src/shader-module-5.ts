/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_5
...
export interface GraphicsShaderModule_5Uniforms {
...
export class GraphicsShaderModule_5Pipeline {
  private uniforms: GraphicsShaderModule_5Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_5Uniforms>) {
    this.uniforms = {
