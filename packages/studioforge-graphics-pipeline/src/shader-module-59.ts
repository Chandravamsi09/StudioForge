/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_59
...
export interface GraphicsShaderModule_59Uniforms {
...
export class GraphicsShaderModule_59Pipeline {
  private uniforms: GraphicsShaderModule_59Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_59Uniforms>) {
    this.uniforms = {
