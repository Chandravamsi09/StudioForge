/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_30
...
export interface GraphicsShaderModule_30Uniforms {
...
export class GraphicsShaderModule_30Pipeline {
  private uniforms: GraphicsShaderModule_30Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_30Uniforms>) {
    this.uniforms = {
