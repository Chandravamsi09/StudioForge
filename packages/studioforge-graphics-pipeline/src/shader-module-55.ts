/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_55
...
export interface GraphicsShaderModule_55Uniforms {
...
export class GraphicsShaderModule_55Pipeline {
  private uniforms: GraphicsShaderModule_55Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_55Uniforms>) {
    this.uniforms = {
