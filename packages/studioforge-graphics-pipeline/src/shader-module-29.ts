/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_29
...
export interface GraphicsShaderModule_29Uniforms {
...
export class GraphicsShaderModule_29Pipeline {
  private uniforms: GraphicsShaderModule_29Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_29Uniforms>) {
    this.uniforms = {
