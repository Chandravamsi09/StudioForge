/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_45
...
export interface GraphicsShaderModule_45Uniforms {
...
export class GraphicsShaderModule_45Pipeline {
  private uniforms: GraphicsShaderModule_45Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_45Uniforms>) {
    this.uniforms = {
