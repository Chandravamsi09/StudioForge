/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_11
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_11DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_11Executor {
  private descriptor: ComputeShaderPipeline_11DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_11DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_11_MainKernel',
