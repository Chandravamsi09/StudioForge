/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_20
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_20DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_20Executor {
  private descriptor: ComputeShaderPipeline_20DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_20DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_20_MainKernel',
