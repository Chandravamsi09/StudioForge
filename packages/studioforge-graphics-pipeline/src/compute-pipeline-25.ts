/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_25
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_25DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_25Executor {
  private descriptor: ComputeShaderPipeline_25DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_25DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_25_MainKernel',
