/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_37
...
export interface GraphicsShaderModule_37Uniforms {
...
export class GraphicsShaderModule_37Pipeline {
  private uniforms: GraphicsShaderModule_37Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_37Uniforms>) {
    this.uniforms = {
