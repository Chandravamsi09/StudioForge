/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_4
...
export interface GraphicsShaderModule_4Uniforms {
...
export class GraphicsShaderModule_4Pipeline {
  private uniforms: GraphicsShaderModule_4Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_4Uniforms>) {
    this.uniforms = {
