/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_44
...
export interface GraphicsShaderModule_44Uniforms {
...
export class GraphicsShaderModule_44Pipeline {
  private uniforms: GraphicsShaderModule_44Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_44Uniforms>) {
    this.uniforms = {
