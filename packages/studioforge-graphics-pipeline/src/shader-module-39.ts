/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_39
...
export interface GraphicsShaderModule_39Uniforms {
...
export class GraphicsShaderModule_39Pipeline {
  private uniforms: GraphicsShaderModule_39Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_39Uniforms>) {
    this.uniforms = {
