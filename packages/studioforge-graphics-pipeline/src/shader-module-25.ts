/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_25
...
export interface GraphicsShaderModule_25Uniforms {
...
export class GraphicsShaderModule_25Pipeline {
  private uniforms: GraphicsShaderModule_25Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_25Uniforms>) {
    this.uniforms = {
