/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_17
...
export interface GraphicsShaderModule_17Uniforms {
...
export class GraphicsShaderModule_17Pipeline {
  private uniforms: GraphicsShaderModule_17Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_17Uniforms>) {
    this.uniforms = {
