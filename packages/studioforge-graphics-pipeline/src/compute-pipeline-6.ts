/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_6
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_6DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_6Executor {
  private descriptor: ComputeShaderPipeline_6DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_6DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_6_MainKernel',
