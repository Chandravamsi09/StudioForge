/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_27
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_27DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_27Executor {
  private descriptor: ComputeShaderPipeline_27DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_27DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_27_MainKernel',
