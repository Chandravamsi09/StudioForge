/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_36
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_36DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_36Executor {
  private descriptor: ComputeShaderPipeline_36DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_36DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_36_MainKernel',
