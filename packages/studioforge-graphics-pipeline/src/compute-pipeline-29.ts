/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_29
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_29DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_29Executor {
  private descriptor: ComputeShaderPipeline_29DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_29DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_29_MainKernel',
