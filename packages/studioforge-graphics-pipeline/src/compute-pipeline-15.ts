/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_15
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_15DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_15Executor {
  private descriptor: ComputeShaderPipeline_15DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_15DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_15_MainKernel',
