/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_54
...
export interface GraphicsShaderModule_54Uniforms {
...
export class GraphicsShaderModule_54Pipeline {
  private uniforms: GraphicsShaderModule_54Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_54Uniforms>) {
    this.uniforms = {
