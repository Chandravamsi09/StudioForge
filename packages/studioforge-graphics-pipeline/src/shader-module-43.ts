/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_43
...
export interface GraphicsShaderModule_43Uniforms {
...
export class GraphicsShaderModule_43Pipeline {
  private uniforms: GraphicsShaderModule_43Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_43Uniforms>) {
    this.uniforms = {
