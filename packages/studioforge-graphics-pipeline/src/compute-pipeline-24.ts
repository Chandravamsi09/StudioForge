/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_24
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_24DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_24Executor {
  private descriptor: ComputeShaderPipeline_24DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_24DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_24_MainKernel',
