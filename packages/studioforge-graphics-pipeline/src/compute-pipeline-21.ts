/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_21
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_21DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_21Executor {
  private descriptor: ComputeShaderPipeline_21DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_21DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_21_MainKernel',
