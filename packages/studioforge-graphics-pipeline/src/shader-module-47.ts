/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_47
...
export interface GraphicsShaderModule_47Uniforms {
...
export class GraphicsShaderModule_47Pipeline {
  private uniforms: GraphicsShaderModule_47Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_47Uniforms>) {
    this.uniforms = {
