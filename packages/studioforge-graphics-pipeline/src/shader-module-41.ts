/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_41
...
export interface GraphicsShaderModule_41Uniforms {
...
export class GraphicsShaderModule_41Pipeline {
  private uniforms: GraphicsShaderModule_41Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_41Uniforms>) {
    this.uniforms = {
