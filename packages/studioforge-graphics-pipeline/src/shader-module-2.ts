/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_2
...
export interface GraphicsShaderModule_2Uniforms {
...
export class GraphicsShaderModule_2Pipeline {
  private uniforms: GraphicsShaderModule_2Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_2Uniforms>) {
    this.uniforms = {
