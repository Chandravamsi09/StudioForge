/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_4
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_4DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_4Executor {
  private descriptor: ComputeShaderPipeline_4DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_4DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_4_MainKernel',
