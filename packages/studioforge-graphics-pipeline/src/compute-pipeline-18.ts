/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_18
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_18DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_18Executor {
  private descriptor: ComputeShaderPipeline_18DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_18DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_18_MainKernel',
