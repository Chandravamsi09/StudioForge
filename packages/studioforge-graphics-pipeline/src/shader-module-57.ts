/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_57
...
export interface GraphicsShaderModule_57Uniforms {
...
export class GraphicsShaderModule_57Pipeline {
  private uniforms: GraphicsShaderModule_57Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_57Uniforms>) {
    this.uniforms = {
