/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_13
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_13DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_13Executor {
  private descriptor: ComputeShaderPipeline_13DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_13DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_13_MainKernel',
