/**
 * StudioForge GPU Compute Dispatcher & ThreadGroup Dispatcher: ComputeShaderPipeline_41
 * Implements GPU indirect draw buffer packing, compute kernel dispatch, and UAV hazard tracking.
 */

export interface ComputeShaderPipeline_41DispatchDescriptor {
  kernelName: string;
...
export class ComputeShaderPipeline_41Executor {
  private descriptor: ComputeShaderPipeline_41DispatchDescriptor;

  constructor(desc?: Partial<ComputeShaderPipeline_41DispatchDescriptor>) {
    this.descriptor = {
      kernelName: 'ComputeShaderPipeline_41_MainKernel',
