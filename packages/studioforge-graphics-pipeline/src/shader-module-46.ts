/**
 * StudioForge PBR Graphics Shader Pipeline: GraphicsShaderModule_46
...
export interface GraphicsShaderModule_46Uniforms {
...
export class GraphicsShaderModule_46Pipeline {
  private uniforms: GraphicsShaderModule_46Uniforms;

  constructor(uniforms?: Partial<GraphicsShaderModule_46Uniforms>) {
    this.uniforms = {
