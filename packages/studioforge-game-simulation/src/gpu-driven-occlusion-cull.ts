/**
 * StudioForge Simulation Engine Subsystem: GpuDrivenOcclusionCull
 */

export interface GpuDrivenOcclusionCullParams {
...
export class GpuDrivenOcclusionCull {
  private params: GpuDrivenOcclusionCullParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<GpuDrivenOcclusionCullParams>) {
    this.params = {
      iterationCount: 8,
