/**
 * StudioForge Simulation Engine Subsystem: VerletClothSimulation
 */

export interface VerletClothSimulationParams {
...
export class VerletClothSimulation {
  private params: VerletClothSimulationParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<VerletClothSimulationParams>) {
    this.params = {
      iterationCount: 8,
