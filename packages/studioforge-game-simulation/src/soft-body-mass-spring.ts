/**
 * StudioForge Simulation Engine Subsystem: SoftBodyMassSpring
 */

export interface SoftBodyMassSpringParams {
...
export class SoftBodyMassSpring {
  private params: SoftBodyMassSpringParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<SoftBodyMassSpringParams>) {
    this.params = {
      iterationCount: 8,
