/**
 * StudioForge Simulation Engine Subsystem: SubsurfaceScatteringSkin
 */

export interface SubsurfaceScatteringSkinParams {
...
export class SubsurfaceScatteringSkin {
  private params: SubsurfaceScatteringSkinParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<SubsurfaceScatteringSkinParams>) {
    this.params = {
      iterationCount: 8,
