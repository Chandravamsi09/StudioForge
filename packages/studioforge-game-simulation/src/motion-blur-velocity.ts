/**
 * StudioForge Simulation Engine Subsystem: MotionBlurVelocity
 */

export interface MotionBlurVelocityParams {
...
export class MotionBlurVelocity {
  private params: MotionBlurVelocityParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<MotionBlurVelocityParams>) {
    this.params = {
      iterationCount: 8,
