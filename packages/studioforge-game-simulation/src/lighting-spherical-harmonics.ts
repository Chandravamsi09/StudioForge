/**
 * StudioForge Simulation Engine Subsystem: LightingSphericalHarmonics
 */

export interface LightingSphericalHarmonicsParams {
...
export class LightingSphericalHarmonics {
  private params: LightingSphericalHarmonicsParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<LightingSphericalHarmonicsParams>) {
    this.params = {
      iterationCount: 8,
