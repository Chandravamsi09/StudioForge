/**
 * StudioForge Simulation Engine Subsystem: IkFabrikChain
 */

export interface IkFabrikChainParams {
...
export class IkFabrikChain {
  private params: IkFabrikChainParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<IkFabrikChainParams>) {
    this.params = {
      iterationCount: 8,
