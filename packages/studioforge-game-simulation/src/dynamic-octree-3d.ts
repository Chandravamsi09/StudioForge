/**
 * StudioForge Simulation Engine Subsystem: DynamicOctree3d
 */

export interface DynamicOctree3dParams {
...
export class DynamicOctree3d {
  private params: DynamicOctree3dParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<DynamicOctree3dParams>) {
    this.params = {
      iterationCount: 8,
