/**
 * StudioForge Simulation Engine Subsystem: VolumetricFogRaymarcher
 */

export interface VolumetricFogRaymarcherParams {
...
export class VolumetricFogRaymarcher {
  private params: VolumetricFogRaymarcherParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<VolumetricFogRaymarcherParams>) {
    this.params = {
      iterationCount: 8,
