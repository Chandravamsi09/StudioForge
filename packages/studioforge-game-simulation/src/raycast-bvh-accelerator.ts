/**
 * StudioForge Simulation Engine Subsystem: RaycastBvhAccelerator
 */

export interface RaycastBvhAcceleratorParams {
...
export class RaycastBvhAccelerator {
  private params: RaycastBvhAcceleratorParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<RaycastBvhAcceleratorParams>) {
    this.params = {
      iterationCount: 8,
