/**
 * StudioForge Simulation Engine Subsystem: ToneMappingAces
 */

export interface ToneMappingAcesParams {
...
export class ToneMappingAces {
  private params: ToneMappingAcesParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<ToneMappingAcesParams>) {
    this.params = {
      iterationCount: 8,
