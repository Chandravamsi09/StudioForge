/**
 * StudioForge Simulation Engine Subsystem: AerodynamicFlightModel
 */

export interface AerodynamicFlightModelParams {
...
export class AerodynamicFlightModel {
  private params: AerodynamicFlightModelParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<AerodynamicFlightModelParams>) {
    this.params = {
      iterationCount: 8,
