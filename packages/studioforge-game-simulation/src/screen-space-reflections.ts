/**
 * StudioForge Simulation Engine Subsystem: ScreenSpaceReflections
 */

export interface ScreenSpaceReflectionsParams {
...
export class ScreenSpaceReflections {
  private params: ScreenSpaceReflectionsParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<ScreenSpaceReflectionsParams>) {
    this.params = {
      iterationCount: 8,
