/**
 * StudioForge Simulation Engine Subsystem: MeshLodDecimator
 */

export interface MeshLodDecimatorParams {
...
export class MeshLodDecimator {
  private params: MeshLodDecimatorParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<MeshLodDecimatorParams>) {
    this.params = {
      iterationCount: 8,
