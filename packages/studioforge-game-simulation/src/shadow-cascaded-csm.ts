/**
 * StudioForge Simulation Engine Subsystem: ShadowCascadedCsm
 */

export interface ShadowCascadedCsmParams {
...
export class ShadowCascadedCsm {
  private params: ShadowCascadedCsmParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<ShadowCascadedCsmParams>) {
    this.params = {
      iterationCount: 8,
