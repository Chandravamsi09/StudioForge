/**
 * StudioForge Simulation Engine Subsystem: IkTwoBoneSolver
 */

export interface IkTwoBoneSolverParams {
...
export class IkTwoBoneSolver {
  private params: IkTwoBoneSolverParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<IkTwoBoneSolverParams>) {
    this.params = {
      iterationCount: 8,
