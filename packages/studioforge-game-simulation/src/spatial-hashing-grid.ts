/**
 * StudioForge Simulation Engine Subsystem: SpatialHashingGrid
 */

export interface SpatialHashingGridParams {
...
export class SpatialHashingGrid {
  private params: SpatialHashingGridParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<SpatialHashingGridParams>) {
    this.params = {
      iterationCount: 8,
