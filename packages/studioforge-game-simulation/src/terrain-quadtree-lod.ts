/**
 * StudioForge Simulation Engine Subsystem: TerrainQuadtreeLod
 */

export interface TerrainQuadtreeLodParams {
...
export class TerrainQuadtreeLod {
  private params: TerrainQuadtreeLodParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<TerrainQuadtreeLodParams>) {
    this.params = {
      iterationCount: 8,
