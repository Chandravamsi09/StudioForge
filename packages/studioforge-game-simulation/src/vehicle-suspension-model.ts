/**
 * StudioForge Simulation Engine Subsystem: VehicleSuspensionModel
 */

export interface VehicleSuspensionModelParams {
...
export class VehicleSuspensionModel {
  private params: VehicleSuspensionModelParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<VehicleSuspensionModelParams>) {
    this.params = {
      iterationCount: 8,
