/**
 * StudioForge Simulation Engine Subsystem: AmbientOcclusionGtao
 */

export interface AmbientOcclusionGtaoParams {
...
export class AmbientOcclusionGtao {
  private params: AmbientOcclusionGtaoParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<AmbientOcclusionGtaoParams>) {
    this.params = {
      iterationCount: 8,
