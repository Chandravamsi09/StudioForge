/**
 * StudioForge Simulation Engine Subsystem: RagdollConstraintSolver
 */

export interface RagdollConstraintSolverParams {
...
export class RagdollConstraintSolver {
  private params: RagdollConstraintSolverParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<RagdollConstraintSolverParams>) {
    this.params = {
      iterationCount: 8,
