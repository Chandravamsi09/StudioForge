/**
 * StudioForge Simulation Engine Subsystem: ContinuousCollisionCcd
 */

export interface ContinuousCollisionCcdParams {
...
export class ContinuousCollisionCcd {
  private params: ContinuousCollisionCcdParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<ContinuousCollisionCcdParams>) {
    this.params = {
      iterationCount: 8,
