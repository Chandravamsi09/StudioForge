/**
 * StudioForge Simulation Engine Subsystem: RigidBodyDynamics
 */

export interface RigidBodyDynamicsParams {
...
export class RigidBodyDynamics {
  private params: RigidBodyDynamicsParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<RigidBodyDynamicsParams>) {
    this.params = {
      iterationCount: 8,
