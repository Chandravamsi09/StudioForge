/**
 * StudioForge Simulation Engine Subsystem: PostProcessBloom
 */

export interface PostProcessBloomParams {
...
export class PostProcessBloom {
  private params: PostProcessBloomParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<PostProcessBloomParams>) {
    this.params = {
      iterationCount: 8,
