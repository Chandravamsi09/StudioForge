/**
 * StudioForge Simulation Engine Subsystem: BuoyancyWaterPhysics
 */

export interface BuoyancyWaterPhysicsParams {
...
export class BuoyancyWaterPhysics {
  private params: BuoyancyWaterPhysicsParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<BuoyancyWaterPhysicsParams>) {
    this.params = {
      iterationCount: 8,
