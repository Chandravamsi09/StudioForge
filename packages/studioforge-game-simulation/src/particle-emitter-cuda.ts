/**
 * StudioForge Simulation Engine Subsystem: ParticleEmitterCuda
 */

export interface ParticleEmitterCudaParams {
...
export class ParticleEmitterCuda {
  private params: ParticleEmitterCudaParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<ParticleEmitterCudaParams>) {
    this.params = {
      iterationCount: 8,
