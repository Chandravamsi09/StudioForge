/**
 * StudioForge Simulation Engine Subsystem: EpaPenetrationDepth
 */

export interface EpaPenetrationDepthParams {
...
export class EpaPenetrationDepth {
  private params: EpaPenetrationDepthParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<EpaPenetrationDepthParams>) {
    this.params = {
      iterationCount: 8,
