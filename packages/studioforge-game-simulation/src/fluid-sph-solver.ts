/**
 * StudioForge Simulation Engine Subsystem: FluidSphSolver
 */

export interface FluidSphSolverParams {
...
export class FluidSphSolver {
  private params: FluidSphSolverParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<FluidSphSolverParams>) {
    this.params = {
      iterationCount: 8,
