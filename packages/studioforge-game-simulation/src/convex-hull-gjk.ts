/**
 * StudioForge Simulation Engine Subsystem: ConvexHullGjk
 */

export interface ConvexHullGjkParams {
...
export class ConvexHullGjk {
  private params: ConvexHullGjkParams;
  private stateBuffer: Float64Array;

  constructor(params?: Partial<ConvexHullGjkParams>) {
    this.params = {
      iterationCount: 8,
