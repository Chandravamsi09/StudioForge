/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_40
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_40AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_40Convolver {
  private acousticNode: SpatialAudioProcessor_40AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_40AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_40',
      reflectionCount: 64,
