/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_17
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_17AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_17Convolver {
  private acousticNode: SpatialAudioProcessor_17AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_17AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_17',
      reflectionCount: 64,
