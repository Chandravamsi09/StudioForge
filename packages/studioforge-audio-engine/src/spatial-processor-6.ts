/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_6
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_6AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_6Convolver {
  private acousticNode: SpatialAudioProcessor_6AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_6AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_6',
      reflectionCount: 64,
