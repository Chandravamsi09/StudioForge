/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_30
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_30AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_30Convolver {
  private acousticNode: SpatialAudioProcessor_30AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_30AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_30',
      reflectionCount: 64,
