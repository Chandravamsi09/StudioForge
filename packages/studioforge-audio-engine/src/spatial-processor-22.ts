/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_22
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_22AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_22Convolver {
  private acousticNode: SpatialAudioProcessor_22AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_22AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_22',
      reflectionCount: 64,
