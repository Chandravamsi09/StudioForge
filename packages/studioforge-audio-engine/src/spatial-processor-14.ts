/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_14
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_14AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_14Convolver {
  private acousticNode: SpatialAudioProcessor_14AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_14AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_14',
      reflectionCount: 64,
