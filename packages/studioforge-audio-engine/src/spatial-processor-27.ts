/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_27
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_27AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_27Convolver {
  private acousticNode: SpatialAudioProcessor_27AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_27AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_27',
      reflectionCount: 64,
