/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_38
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_38AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_38Convolver {
  private acousticNode: SpatialAudioProcessor_38AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_38AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_38',
      reflectionCount: 64,
