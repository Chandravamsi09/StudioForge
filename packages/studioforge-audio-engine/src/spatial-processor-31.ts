/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_31
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_31AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_31Convolver {
  private acousticNode: SpatialAudioProcessor_31AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_31AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_31',
      reflectionCount: 64,
