/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_20
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_20AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_20Convolver {
  private acousticNode: SpatialAudioProcessor_20AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_20AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_20',
      reflectionCount: 64,
