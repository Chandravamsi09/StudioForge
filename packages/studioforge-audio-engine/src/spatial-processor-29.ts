/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_29
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_29AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_29Convolver {
  private acousticNode: SpatialAudioProcessor_29AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_29AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_29',
      reflectionCount: 64,
