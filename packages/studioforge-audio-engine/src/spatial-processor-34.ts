/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_34
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_34AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_34Convolver {
  private acousticNode: SpatialAudioProcessor_34AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_34AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_34',
      reflectionCount: 64,
