/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_50
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_50AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_50Convolver {
  private acousticNode: SpatialAudioProcessor_50AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_50AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_50',
      reflectionCount: 64,
