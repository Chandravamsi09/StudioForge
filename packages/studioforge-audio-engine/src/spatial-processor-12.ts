/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_12
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_12AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_12Convolver {
  private acousticNode: SpatialAudioProcessor_12AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_12AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_12',
      reflectionCount: 64,
