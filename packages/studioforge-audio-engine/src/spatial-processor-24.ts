/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_24
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_24AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_24Convolver {
  private acousticNode: SpatialAudioProcessor_24AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_24AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_24',
      reflectionCount: 64,
