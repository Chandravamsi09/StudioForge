/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_16
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_16AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_16Convolver {
  private acousticNode: SpatialAudioProcessor_16AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_16AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_16',
      reflectionCount: 64,
