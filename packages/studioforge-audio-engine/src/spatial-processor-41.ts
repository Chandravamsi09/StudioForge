/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_41
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_41AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_41Convolver {
  private acousticNode: SpatialAudioProcessor_41AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_41AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_41',
      reflectionCount: 64,
