/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_47
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_47AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_47Convolver {
  private acousticNode: SpatialAudioProcessor_47AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_47AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_47',
      reflectionCount: 64,
