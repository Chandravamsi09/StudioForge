/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_39
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_39AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_39Convolver {
  private acousticNode: SpatialAudioProcessor_39AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_39AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_39',
      reflectionCount: 64,
