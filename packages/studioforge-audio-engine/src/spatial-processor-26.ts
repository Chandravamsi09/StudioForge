/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_26
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_26AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_26Convolver {
  private acousticNode: SpatialAudioProcessor_26AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_26AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_26',
      reflectionCount: 64,
