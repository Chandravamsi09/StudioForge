/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_21
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_21AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_21Convolver {
  private acousticNode: SpatialAudioProcessor_21AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_21AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_21',
      reflectionCount: 64,
