/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_28
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_28AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_28Convolver {
  private acousticNode: SpatialAudioProcessor_28AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_28AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_28',
      reflectionCount: 64,
