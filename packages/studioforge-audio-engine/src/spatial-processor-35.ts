/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_35
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_35AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_35Convolver {
  private acousticNode: SpatialAudioProcessor_35AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_35AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_35',
      reflectionCount: 64,
