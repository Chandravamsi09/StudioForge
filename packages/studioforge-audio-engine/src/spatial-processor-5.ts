/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_5
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_5AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_5Convolver {
  private acousticNode: SpatialAudioProcessor_5AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_5AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_5',
      reflectionCount: 64,
