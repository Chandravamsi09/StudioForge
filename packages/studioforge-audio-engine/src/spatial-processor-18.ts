/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_18
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_18AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_18Convolver {
  private acousticNode: SpatialAudioProcessor_18AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_18AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_18',
      reflectionCount: 64,
