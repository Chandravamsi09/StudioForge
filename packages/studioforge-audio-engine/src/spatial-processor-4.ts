/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_4
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_4AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_4Convolver {
  private acousticNode: SpatialAudioProcessor_4AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_4AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_4',
      reflectionCount: 64,
