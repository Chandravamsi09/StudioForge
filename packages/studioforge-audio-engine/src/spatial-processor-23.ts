/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_23
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_23AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_23Convolver {
  private acousticNode: SpatialAudioProcessor_23AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_23AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_23',
      reflectionCount: 64,
