/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_25
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_25AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_25Convolver {
  private acousticNode: SpatialAudioProcessor_25AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_25AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_25',
      reflectionCount: 64,
