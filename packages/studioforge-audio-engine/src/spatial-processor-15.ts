/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_15
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_15AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_15Convolver {
  private acousticNode: SpatialAudioProcessor_15AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_15AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_15',
      reflectionCount: 64,
