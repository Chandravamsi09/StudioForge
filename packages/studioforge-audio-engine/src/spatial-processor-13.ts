/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_13
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_13AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_13Convolver {
  private acousticNode: SpatialAudioProcessor_13AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_13AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_13',
      reflectionCount: 64,
