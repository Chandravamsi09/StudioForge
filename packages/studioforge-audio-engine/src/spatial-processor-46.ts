/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_46
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_46AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_46Convolver {
  private acousticNode: SpatialAudioProcessor_46AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_46AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_46',
      reflectionCount: 64,
