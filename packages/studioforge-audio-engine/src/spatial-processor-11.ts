/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_11
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_11AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_11Convolver {
  private acousticNode: SpatialAudioProcessor_11AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_11AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_11',
      reflectionCount: 64,
