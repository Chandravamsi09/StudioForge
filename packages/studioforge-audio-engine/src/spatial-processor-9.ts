/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_9
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_9AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_9Convolver {
  private acousticNode: SpatialAudioProcessor_9AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_9AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_9',
      reflectionCount: 64,
