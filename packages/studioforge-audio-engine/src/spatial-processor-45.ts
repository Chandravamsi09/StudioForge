/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_45
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_45AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_45Convolver {
  private acousticNode: SpatialAudioProcessor_45AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_45AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_45',
      reflectionCount: 64,
