/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_33
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_33AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_33Convolver {
  private acousticNode: SpatialAudioProcessor_33AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_33AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_33',
      reflectionCount: 64,
