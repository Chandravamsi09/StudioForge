/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_49
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_49AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_49Convolver {
  private acousticNode: SpatialAudioProcessor_49AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_49AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_49',
      reflectionCount: 64,
