/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_48
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_48AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_48Convolver {
  private acousticNode: SpatialAudioProcessor_48AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_48AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_48',
      reflectionCount: 64,
