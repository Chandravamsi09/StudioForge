/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_37
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_37AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_37Convolver {
  private acousticNode: SpatialAudioProcessor_37AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_37AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_37',
      reflectionCount: 64,
