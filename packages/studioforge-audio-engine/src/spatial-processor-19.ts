/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_19
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_19AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_19Convolver {
  private acousticNode: SpatialAudioProcessor_19AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_19AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_19',
      reflectionCount: 64,
