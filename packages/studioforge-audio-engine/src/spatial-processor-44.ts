/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_44
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_44AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_44Convolver {
  private acousticNode: SpatialAudioProcessor_44AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_44AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_44',
      reflectionCount: 64,
