/**
 * StudioForge HRTF Spatial Convolver & Early Reflection Simulator: SpatialAudioProcessor_36
 * Implements impulse response convolution, acoustic room impulse response (RIR), and occlusion diffraction.
 */

export interface SpatialAudioProcessor_36AcousticNode {
  nodeId: string;
...
export class SpatialAudioProcessor_36Convolver {
  private acousticNode: SpatialAudioProcessor_36AcousticNode;

  constructor(node?: Partial<SpatialAudioProcessor_36AcousticNode>) {
    this.acousticNode = {
      nodeId: 'SpatialAudioProcessor_36',
      reflectionCount: 64,
